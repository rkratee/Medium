...
import { SignupInput } from "@jkratee/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    { type === "signup" ? <LabelledInput label="Name" placeholder="Kratee Jain" onChange={(e) => {
                        setPostInputs({ ...postInputs, name: e.target.value })
                    }} /> : null}
                    <LabelledInput label="Email" placeholder="KrateeJain@gmail.com" onChange={(e) => {
